...
//       {/* Status Filter */}
//       {/* <div className="session-status-filter flex justify-around mb-6">
//         <button
//           onClick={() => setActiveStatus("")}
//           className={`px-6 py-2 rounded-lg text-sm font-semibold transition-all ${activeStatus === ""
...
//             className={`px-6 py-2 rounded-lg text-sm font-semibold transition-all ${activeStatus === status
//                 ? "bg-[#7047A3] text-white"
//                 : "bg-gray-200 text-gray-800"
//               }`}
//           >
...
//       <div className="session-status-filter flex justify-around mb-6 relative">
//         {/* Dropdown Button */}
//         <button
//           onClick={() => setFilterVisible(!filterVisible)}
//           className="flex items-center px-6 py-2 rounded-lg bg-gray-200 text-gray-800 text-sm font-semibold"
...
//               }}
//               className={`block w-full text-left px-6 py-2 text-sm font-semibold rounded-t-lg transition-all ${activeStatus === "" ? "bg-[#7047A3] text-white" : "bg-gray-200 hover:bg-gray-300"
//                 }`}
//             >
//               All
//             </button>
...
//                   setFilterVisible(false);
//                 }}
//                 className={`block w-full text-left px-6 py-2 text-sm font-semibold transition-all ${activeStatus === status ? "bg-[#7047A3] text-white" : "bg-gray-200 hover:bg-gray-300"
//                   }`}
//               >
//                 {status}
//               </button>
...
//           </div>
//         )}
//         <div className={`filter-dropdown ${filterVisible ? "active" : ""}`}>
//           <button
//             onClick={() => {
//               setActiveStatus("");
//               setFilterVisible(false);
//             }}
//             className={`px-6 py-2 text-sm font-semibold rounded-lg transition-all ${activeStatus === "" ? "bg-[#7047A3] text-white" : "bg-gray-200"
//               }`}
//           >
//             All
//           </button>
...
//                 setFilterVisible(false);
//               }}
//               className={`px-6 py-2 text-sm font-semibold rounded-lg transition-all ${activeStatus === status ? "bg-[#7047A3] text-white" : "bg-gray-200"
//                 }`}
//             >
//               {status}
//             </button>
...
// }) => {
//   return (
//     // <div className="session-table-container pt-1 bg-white rounded-lg shadow-md relative">
//     //   <h1 className="session-table-title text-2xl font-bold mb-6 text-[#7047A3]">Sessions</h1>
//     //   <div className="session-table-content-container overflow-x-auto">
//     //     <table className="session-table min-w-full table-auto border-collapse border border-gray-300">
...
//     //         </tr>
//     //       </thead>
//     //       <tbody className="session-table-body bg-white divide-y divide-gray-200">
...
//                 <td>{session.b_mode}</td>
//                 <td>{new Date(session.b_date).toLocaleDateString()}</td>
//                 <td>{session.b_time_slot}</td>
